...
<cfif isdefined('Approve')>
	...
	<cfquery name="app" datasource="BusinessPLUS">
		...
		SET principal_app_deny = 'A',
			principal_app_deny_date = '#dateApproved#'
		WHERE setid = '#session.pending.setid#'
	</cfquery>
	
	<cfmail from="bj.shay@d51schools.org" subject="Pending Stipends" to="Cristal.Chavez@d51schools.org" type="html" bcc="bj.shay@d51schools.org">
...
<body>
	...
	<cfform name="appdeny" action="prinAppDeny.cfm" method="post">
		<center>
